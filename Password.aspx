            ...
            <div style="min-height: 600px;">
				...
				<br/>
                        ...
                        <div style="margin: 40px; display: flex; flex-direction: column; justify-content: flex-start; align-items: left; text-align: left;">
							...
							<label for="txtPassword" style="font-family: sans-serif; color: white; margin-bottom: 10px;padding-right: 10%; width: 180px;">New Password:</label>
							<asp:TextBox TextMode="Password" runat="server" ID="txtPassword" Width="200px" style="background: #00000030; height: 40px; color:#FFFFFF; border-radius: 10px; border: none; margin: 0 auto; display:flex; align-items: center; text-align: center;"/>
							<br />
							<label for="txtConfirmPassword" style="font-family: sans-serif; color: white; margin-bottom: 10px;padding-right: 10%; width: 180px;">Confirm Password:</label>
							<asp:TextBox TextMode="Password" runat="server" ID="txtConfirmPassword" Width="200px" style="background: #00000030; height: 40px; color:#FFFFFF; border-radius: 10px; border: none; margin: 0 auto; display:flex; align-items: center; text-align: center;"/>
							<br />
