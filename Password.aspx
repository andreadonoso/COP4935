								...
								<table style="width: 100%;">
									<tr>
										<td colspan="2" style="text-align: center;">
											<h1 style="font-family: Arial, Helvetica, sans-serif; color: #FFFFFF; font-size: 35px; width: 75%; font-weight: 900; line-height: 34px; letter-spacing: 0em; margin: 0 auto; padding-bottom: 10px;">Change Password</h1>
										</td>
									</tr>

									<tr>
										<td colspan="2" align="center" style="padding: 20px 30px;">
											<label for="txtNewPassword" style="font-family: sans-serif; color: white; margin-bottom: 10px;padding-right: 25%;">New Password</label><br>
									...
									<tr>
										<td colspan="2" align="center" style="padding: 20px 30px;">
											<label for="txtConfirmPassword" style="font-family: sans-serif; color: white; margin-bottom: 10px;padding-right: 16%;">Confirm Password</label><br>
