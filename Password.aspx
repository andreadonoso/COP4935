...
<body>
    ...
    <div style="background-color: lightblue; width: 100%; height: 100%; position: absolute; top: 0; left: 0; text-align: center;">
		...
		<div style="background-color: #ffffee; width:500px; height: 256px; margin: auto; border-radius: 25px;">
			<br />
			<center>
				<table border="1">
					<tr><td align="right" style="padding:10px">New Password: </td><td style="padding:10px"><asp:TextBox TextMode="Password" runat="server" ID="txtPassword" Width="200px" /></td></tr>
					<tr><td align="right" style="padding:10px">Confirm Password: </td><td style="padding:10px"><asp:TextBox TextMode="Password" runat="server" ID="txtConfirmPassword" Width="200px" /></td></tr>
