<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CDR.aspx.cs" Inherits="CDR" %>
        ...
        <form id="form1" runat="server">
            <div style="min-height: 600px;">
                ...
                <asp:Literal runat="server" ID="litBoxDiv"/>
                        ...
                        <h4 style="color: #ffffff">My Team Peer Review</h4>
                        <p>View the score your classmates gave your team or review your own team members</p>
                        <div style="padding-bottom: 10px;">
                            <asp:Button ID="btnSeeMyGroupsPeerReview" runat="server" Text="View My Score" OnClick="btnSeeMyGroupsPeerReview_Click" style="color: white; background: #000000; width: auto; border-radius: 10px; border: none; padding: 10px 30px"/>
                        </div>
                        <div style="padding-bottom: 10px;">
                            <asp:Button ID="btnGiveGroupReview" runat="server" Text="Review Team Members" OnClick="btnGiveGroupPeerReview_Click" style="color: white; background: #000000; width: auto; border-radius: 10px; border: none; padding: 10px 30px"/>
                        </div>
                        <br />
                        <h4 style="color: #ffffff">Class Peer Review</h4>
                        <p>Review the other teams in your class</p>
                        <div>
                            <asp:Button ID="btnPeerReview" runat="server" Text="Review Teams" OnClick="btnPeerReview_Click" style="color: white; background: #000000; width: auto; border-radius: 10px; border: none; padding: 10px 30px"/>
                        </div>
