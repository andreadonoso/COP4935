...
<br/>
                        ...
                        <div style="margin: 40px; display: flex; flex-direction: column; justify-content: flex-start; align-items: left; text-align: left;">
                            <center>
                                ...
                                <br />
                                <p style = "color: white;">Select Date Below:</p>
                                <br />
                                <center>
                                ...
                                <br />
                                <asp:Button ID="btnBackToCDR" runat="server" Text="Exit" style="width:100%;max-width:190px;color: white; background: #000000; height: 40px; border-radius: 10px; border: none;@media screen and (max-width: 480px) {
                                    font-size: 14px; /* Adjust font size for mobile view */}" OnClick="btnBackToCDR_Click" />
                            </center>
