                                ...
                                <div style="background-color: rgba(0, 0, 0, 0.44); color: #ffffff; border-radius: 25px; width: 100%; padding: 0px 35px;">
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td style="padding-top:20px">GROUP NUMBER </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <th style="padding-bottom:20px"><asp:Label runat="server" ID="lblGroupNumber" /></th>
                                        </tr>
                                        <tr>
                                            <td style="padding-bottom:0px">LEVEL </td> 
                                            <td style="padding-bottom:0px">DATE LAST ON </td> 
                                        </tr>
                                        <tr>
                                            <th style="padding-bottom:20px"><asp:Label runat="server" ID="lblLevel" /></th>
                                            <th style="padding-bottom:20px"><asp:Label runat="server" ID="lblDateLastOn" /></th>
                                        </tr>
                                        <tr>
                                            
                                            <td style="padding-bottom:0px">PROGRAM </td> 
                                            <td style="padding-bottom:0px">LOGIN COUNT </td> 
                                        </tr>
                                        <tr>
                                            <th style="padding-bottom:20px"><asp:Label runat="server" ID="lblProgram" /></th>
                                            <th style="padding-bottom:20px"><asp:Label runat="server" ID="lblLoginCount" /></th>
                                        </tr>
                                    </table>
                                </div>
                            </center>
