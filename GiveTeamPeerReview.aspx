...
<br/>
					...
					<div style="margin: 40px; display: flex; flex-direction: column; justify-content: flex-start; align-items: left; text-align: left;">
						<center>
						<br><br> <h4 style="color: #ffffff">Team Members Peer Review</h4>
							...
							<table style="width: 100%;">
								...
								<tr>
									<td colspan="2" align="center">
										<asp:Button ID="btnBackToCDR" runat="server" Text="Cancel" OnClick="btnBackToCDR_Click" style="color: white; background-color: transparent; width: 70%; height: 40px; border: none;" />
									</td>
								</tr>
